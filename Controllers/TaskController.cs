...
namespace BackEnd_Server.Controllers
{
    ...
    public class TaskController : Controller
    {
        ...
        public async Task<ActionResult<ProductBacklog>> InsertTaskInProductBacklog([FromBody] Models.Task task)
        {
            if (task == null || task.ProductBacklog == null || task.ProductBacklog.Id <= 0)
            {
            ...
            var productBacklog = await _context.ProductBacklog
                .Include(
                    pb => pb.Tasks) // Incluir las tareas existentes
                .FirstOrDefaultAsync(
                    pb => pb.Id == task.ProductBacklog.Id);
            ...
            task.ProductBacklog = productBacklog;
